    ...
    void FixedUpdate()
    {
        ...
        if (manager.GetUsersCount() > 0)
        {
            ...
            if (SensorRecorderManager.startRecordingSensorData)
            {
                ...
                dataCollection.shoulder_center_Y.AddRecordedValue(shoulder_center_Z);
            }
        }
        else
        {
