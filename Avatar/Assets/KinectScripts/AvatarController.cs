...
{	
    ...
    [Tooltip("Whether the user is facing the Kinect or not.")]
    public bool returnedUser = false;
...
//		}
	...
	protected void TransformBone(Int64 userId, KinectInterop.JointType joint, int boneIndex, bool flip)
    {
        ...
        if (returnedUser)
            jointRotation = new Quaternion(-jointRotation.x, -jointRotation.y, jointRotation.z, jointRotation.w);
