        ...
        */
        ...
        public override void OnInspectorGUI()
        {
            ...
            for (int i = 0; i < waypoints.Length; i++)
            {
                ...
                Transform obj = EditorGUILayout.ObjectField(waypoints[i], typeof(Transform), true) as Transform;

                if (obj)
                {
                    waypoints[i].position = obj.position;
                }
        ...
        private void DrawPathOptions()
        {
            ...
            switch (editOption)
            {
                ...
                case PathModifierOption.CenterOnFirstPoint:
                    Undo.RecordObjects(waypoints, "Update Path CenterOnFirstPoint");
                    (m_Object.targetObject as PathManager).CreateAndCenter();
                    SceneView.RepaintAll();
                    break;
            }
