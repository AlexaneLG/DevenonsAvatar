...
namespace RockVR.Video
{
    ...
    public class VideoCapture : VideoCaptureBase
    {
        ...
        private void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            //            blitMaterial.mainTextureOffset = new Vector2(vp.x, vp.y);
            //            blitMaterial.mainTextureScale = new Vector2(vp.width, vp.height);
        ...
        void CopyFrameTexture()
        {
            ...
            var vp = captureCamera.rect;

            // TODO, remove expensive step of copying pixel data from GPU to CPU.
            frameTexture.ReadPixels(new Rect(Screen.width * vp.x, 0, frameWidth, frameHeight), 0, 0, false);
            frameTexture.Apply();
