...
public class MyCustomBuild : IAdvancedCustomBuild
{
	...
	public void OnEveryBuildStart()
	{
		Debug.Log("Triggered at the beginning of the first build");
	}
	...
	public void OnPreApplyConfiguration(Configuration configuration, bool isBuilding)
	{
		Debug.Log("Do stuff before apply configuration named '" + configuration.name + "', isBuilding: " + isBuilding);
	}

	public void OnPostApplyConfiguration(Configuration configuration, bool isBuilding)
	{
		Debug.Log("Do stuff after apply configuration named '" + configuration.name + "', isBuilding: " + isBuilding);
	}
}
