...
namespace PygmyMonkey.AdvancedBuilder
{
	public class AdvancedSettingsRenderer : IDefaultRenderer
	{
		...
		public void drawInspector()
		{
            ...
            m_advancedSettings.removeSpacesFromBuildPath = EditorGUILayout.ToggleLeft("Remove all spaces from the final build path", m_advancedSettings.removeSpacesFromBuildPath);
