...
namespace WiiBalanceWalker
{
    public partial class FormMain : Form
    {
        ...
        public static float owTLTempSensorValue;
        public static float owTRTempSensorValue;
        public static float owBLTempSensorValue;
        public static float owBRTempSensorValue;
        ...
        private void InfoUpdate()
        {
            ...
            owTLTempSensorValue = owTopLeft;
            owTRTempSensorValue = owTopRight;
            owBLTempSensorValue = owBottomLeft;
            owBRTempSensorValue = owBottomRight;
        ...
        private void label_owTL_Click(object sender, EventArgs e)
        {

        }

        private void label_ActionLeft_Click(object sender, EventArgs e)
        {
